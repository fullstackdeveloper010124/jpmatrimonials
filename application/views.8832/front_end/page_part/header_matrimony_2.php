...
<html lang="en">
   ...
   <?php
	...
	<?php } ?>
		...
		<link rel="stylesheet"
		href="<?php echo $base_url;?>assets/home_2/css/jquery.mCustomScrollbar.min.css?v=<?php echo filemtime('assets/home_2/css/jquery.mCustomScrollbar.min.css') ?>">
		...
		if($is_login){
			...
			<li class="'.$my_match.' nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown1">
					<a class="dropdown-item" href="'.$base_url.'matches">Matches</a>
					<a class="dropdown-item" href="'.$base_url.'matches/received-match-from-admin">Recommended Match</a>
				</div>
			</li>
			...
			$mobile_menu='<!--profile detail-->
               <div class="col-xs-12 col-sm-12  margin-top-20">
				...
				<ul class="list-unstyled components">
					...
					<li class="clearfix"> <a href="#homeSubmenu1212" data-toggle="collapse"
						aria-expanded="false">Activity<i class="fas fa-angle-down"></i></a>
						<ul class="collapse list-unstyled ul-li-bg" id="homeSubmenu1212">
							<li><a href="'.$base_url.'express-interest">My Express Interest</a></li>
							<li><a href="'.$base_url.'message">My Messages</a></li>
					...
					<li class="clearfix"> <a href="#homeSubmenu1" data-toggle="collapse"
						...
						<ul class="collapse list-unstyled ul-li-bg" id="homeSubmenu1">
							...
							<li><a href="'.$base_url.'matches/received-match-from-admin">Recommended Match</a></li>
						</ul>
					</li>
			...
			<li><a href="'.$base_url.'login" class="last-child-menu"> <i class="fas fa-sign-in-alt"></i> Log In</a></li></ul>
			';
	...
	<body class="<?php echo $body_class; ?>">
		...
		<?php if($this->router->fetch_class()!='home'){ echo '<div class="mt-1"></div>';}?>