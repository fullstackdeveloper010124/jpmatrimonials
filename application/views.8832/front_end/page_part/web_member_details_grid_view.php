   ...
   <div class="m-b " style="<?php echo $badgebackStyle;?>position: relative;">
        ...
        <div class="row">
         ...
         <?php if(isset($member_data_val['gender']) && $member_data_val['gender']=='Female'){
            ...
            <div class="gried_parag_box">
                  <h6><?php echo $comm_model->display_data_na($member_data_val['matri_id']);?> |
                  ...
                  <p ><?php echo $comm_model->birthdate_disp($member_data_val['birthdate'],0);?>, <?php echo $comm_model->display_height($member_data_val['height']);?>, <?php echo $comm_model->display_data_na($member_data_val['religion_name']);?>, <?php echo $comm_model->display_data_na($member_data_val['caste_name']);?></p>
            </div>
         </div>
      </div>
   </div>
