...
class Sales_report_model extends CI_Model {
	public $session_search_name;
	public function __construct()
	{
		parent::__construct();
		// $this->session_search_name = 'sales_report_search_session';
		$this->session_search_name = 'member_search_session';
	...
	function list_model($status ='ALL', $page =1,$personal_where='')
	{
		...
		$data_table = array(
			...
			'disp_status'=>'no',
			'disp_column_array'=> array('plan_name','email','category_type','payment_mode','plan_activated','plan_expired','plan_duration','plan_amount','grand_total','current_plan')
		);
