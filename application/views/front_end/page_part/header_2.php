...
<html lang="en">
	...
	<?php } ?>
		...
		$is_vendorlogin = $this->common_front_model->checkLoginVendor('return');
		if(($is_login))
		{
		...
		if($is_login){
			...
			$home = $cms = $my_search = $register = $premium_member = $contact =  $success_story = $vendorRegister = $vendorMembership = $vendorDashboard = '';
			$class_name_curr = $this->common_model->class_name;			
			...
			}elseif($class_name_curr == 'vendor' && ($this->common_model->method_name == 'vendor_register' || $this->common_model->method_name == 'vendor_login') || $class_name_curr == 'wedding_vendor'){
				$vendorRegister = 'menu-active cool-link';					
			}elseif($class_name_curr == 'vendor' && ($this->common_model->method_name == 'payment_option' || $this->common_model->method_name == 'current_plan')){
				$vendorMembership = 'menu-active cool-link';						
			}elseif($class_name_curr == 'vendor' && $this->common_model->method_name == 'vendor_dashboard'){
				$vendorDashboard = 'menu-active cool-link';
			}			

			$vendorPlanstatus = '';
			$paymentOption = '';
			$plan_status = $this->common_front_model->get_vendor_session_data('plan_status');

			if ($plan_status && $plan_status !== 'Not Paid') {
				// Show Current Plan
				$vendorPlanstatus = '<a class="dropdown-item" href="'.$base_url.'vendor-current-plan">Current Plan</a>';

				// Show Payment Option only if plan is Expired
				if ($plan_status === 'Expired') {
					$paymentOption = '<a class="dropdown-item" href="'.$base_url.'vendor-payment-option">Payment Option</a>';
				}
			} else {
				// If Not Paid or empty, show Payment Option
				$paymentOption = '<a class="dropdown-item" href="'.$base_url.'vendor-payment-option">Payment Option</a>';
			}
			$is_vendorlogin = $this->common_front_model->checkLoginVendor('return');
			$method_name_curr = $this->common_model->method_name;	
			if($is_vendorlogin && ($method_name_curr == 'vendor_dashboard' || $class_name_curr == 'vendor' && $method_name_curr == 'payment_option' || $method_name_curr == 'current_plan'))
			{
					$main_menu_str = '
						<ul class="clearfix">
							<li class="'.$vendorDashboard.'"><a href="'.$base_url.'vendor-dashboard">Vendor Dashbaord</a></li>									
							<li class="'.$vendorMembership.' nav-item dropdown">
								<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown3" role="button"
									data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Membership <span class="caret"></span>
								</a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown3">
									'.$paymentOption.'
									'.$vendorPlanstatus.'
							...
							<li class="active nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown5">
									<a class="dropdown-item" href="'.$base_url.'vendor-logout">Logout</a>
								</div>
							</li>			
						</ul>
						';
					...
					$mobile_menu='
						<hr class="pro_m_hr">
						<ul class="list-unstyled components">
							<li><a href="'.$base_url.'vendor-dashboard">Vendor Dashbaord</a></li>	
							<li class="clearfix"> <a href="#up-garde" data-toggle="collapse"
								aria-expanded="false"> Membership <i class="fas fa-angle-down"></i></a>
								<ul class="collapse list-unstyled ul-li-bg" id="up-garde">
									'.$paymentOption.'
							...
							<li class="clearfix"> <a href="#user" data-toggle="collapse"
								aria-expanded="false"> User <i class="fas fa-angle-down"></i></a>
								<ul class="collapse list-unstyled ul-li-bg" id="user">
									<li><a href="'.$base_url.'vendor-logout">Logout</a></li>
								</ul>
							</li>				
						</ul>	
					';
					...
					$is_vendorlogin = $this->common_front_model->checkLoginVendor('return');
					$vendorMainMenu = '<li><a href="'.$base_url.'vendor-dashboard">Vendor Dashbaord</a></li>	';
					$vendorMobileMenu = '<li><a href="'.$base_url.'vendor-dashboard">Vendor Dashbaord</a></li>	';
					if(!$is_vendorlogin){
						$vendorMainMenu = '
									<li class="nav-item dropdown '.$vendorRegister.'">
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown7">
										<a class="dropdown-item" href="'.$base_url.'vendor-register"> Vendor Register</a>
										<a class="dropdown-item" href="'.$base_url.'vendor-login"> Vendor Login</a>
										<a class="dropdown-item" href="'.$base_url.'wedding-vendor"> Vendors</a>
									</div>
								</li>
						';
						$vendorMobileMenu = '			
							<li class="clearfix"> <a href="#homeSubmenu15" data-toggle="collapse"
								aria-expanded="false">Vendor<i class="fas fa-angle-down"></i></a>
								<ul class="collapse list-unstyled ul-li-bg" id="homeSubmenu15">
									<li><a href="'.$base_url.'vendor-register"> Vendor Register</a></li>
									<li><a href="'.$base_url.'vendor-login"> Vendor Login</a></li>
									<li><a href="'.$base_url.'wedding-vendor"> Vendors</a></li>
								</ul>
							</li>';
					}
					$main_menu_str = '
	...
	<body class="<?php echo $body_class; ?>" style="<?php echo $back_img;?>">
		<div class="_banner">
			...
			<div class="menu-position">
				...
				<div class="MobileMenu hidden-lg  hidden-md clearfix ps-Sticky" style="background: #fff;">
