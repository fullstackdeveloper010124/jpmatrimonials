    		...
    		<nav role="navigation">
      			<ul class="nav">
        			...
        			<li id="dashboard" <?php if(isset($page_title) && $page_title =='Dashboard'){ echo 'class="active"';} ?>>
						...
						<ul class=sub-menu>
							<li id="dashboard" <?php if(isset($page_title) && $page_title =='Dashboard'){ echo 'class="active"';} ?>>
								<a href="<?php echo $base_url.$admin_path.'/dashboard';?>"> <span>Dashboard</span> </a> 
							</li>
							<?php
   							if($user_type == 'admin'){ ?>
								<li id="color_change"> <a href="<?php echo $base_url.$admin_path.'/dashboard/color-change';?>"> <span>Change Website Theme Color </span> </a> </li>
							<?php } ?>
						</ul>
                    </li>
        			<?php
                    ...
                    <li id="site_setting">
                    	<a href=javascript:;> <i class="fa fa-cogs"></i> <span>Site Settings</span> </a>
      					<ul class=sub-menu>
                            ...
                            <li id="site_image"> <a href="<?php echo $base_url.$admin_path.'/site-setting/site_image';?>"> <span>Site Default Image</span> </a> </li>
							<li id="update_email"> <a href="<?php echo $base_url.$admin_path.'/site-setting/update-email';?>"> <span>Email Settings</span> </a> </li>
							...
							<li id="notification_setting"> <a href="<?php echo $base_url.$admin_path.'/site-setting/notification_setting';?>"> <span>Firebase Setting</span> </a> </li>
                        </ul>
			        </li>
                    <li id="new_listing">
                    	<a href=javascript:;> <i class="fa fa-plus"></i> <span>Add New Details</span> </a>
          				<ul class=sub-menu>
							...
							<li id="currency_man"> <a href="<?php echo $base_url.$admin_path.'/new-listing/currency-man/ALL/1/yes';?>"> <span>Add Currency Management</span> </a> </li>
							<!-- For issue start 29/11/2021  -->
							<li id="mobile_matri_bannner"> <a href="<?php echo $base_url.$admin_path.'/new-listing/mobile_matri_bannner/ALL/1/yes';?>"> <span>Mobile Matri Bannner</span> </a> </li>
							<!-- For issue end 29/11/2021  -->
							<li class="new_listing_add" id="income_list">
                            	<a href="<?php echo $base_url.$admin_path.'/new-listing/income_list/ALL/1/yes';?>"> <span>Annual Income</span> </a>
                            </li>
			          	</ul>
			        </li>
					<li id="homepage_management">
                    	<a href=javascript:;> <i class="fa fa-plus"></i> <span>Homepage Management</span> </a>
          				<ul class=sub-menu>
          					<li class="banner" id="homepage_management">
                            	<a href="<?php echo $base_url.$admin_path.'/homepage-management/banner/ALL/1/yes';?>"> <span>Home Page Banner</span> </a> 
                            </li>
						  	<li id="homepage_text" class="homepage_management" >  <a href="<?php echo $base_url.$admin_path.'/homepage-management/homepage-text';?>"> <span>Homepage Text</span> </a> </li>
							 <li id="other_banner" >
                            	<a href="<?php echo $base_url.$admin_path.'/homepage-management/other_banner';?>"> <span>Homepage Banner Text</span> </a> 
                            </li>
							<li id="reason_why_choose">
                            	<a href="<?php echo $base_url.$admin_path.'/homepage-management/reason_why_choose/ALL/1/yes';?>"> <span>Reason Why Choose</span> </a> 
                            </li>
							<li id="banner_quick_info">
                            	<a href="<?php echo $base_url.$admin_path.'/homepage-management/banner_quick_info/ALL/1/yes';?>"> <span>Banner Quick Info</span> </a> 
                            </li>
			          	</ul>
			        </li>
					<li id="seo_management">
                    	<a href=javascript:;> <i class="fa fa fa-building-o"></i> <span>SEO Management</span> </a>
          				<ul class=sub-menu>
						    <li class="site_setting_add view_detail" id="seo_pages"><a href="<?php echo $base_url.$admin_path.'/seo-management/seo-pages/ALL/1/yes';?>"> <span>SEO Pages Optimization</span> </a></li>
						    <li class="new_listing_add" id="add_matrimoni_data">
                            	<a href="<?php echo $base_url.$admin_path.'/seo-management/add_matrimoni_data/ALL/1/yes';?>"> <span>Matrimony Pages </span> </a> 
                            </li>
						    <li class="blog_management_add" id="blog_list">
                            	<a href="<?php echo $base_url.$admin_path.'/seo-management/blog-list/ALL/1/yes';?>"> <span>Blog Management</span> </a> 
                            </li>
                    	...
                    	<a href=javascript:;> <i class="fa fa-user"></i> <span>Member</span> </a>
          				<ul class="sub-menu">
                            ...
                            <li class="member_add member_detail" id="upgrade_member_list">
                            	<a href="<?php echo $base_url.$admin_path.'/member/upgrade-member-list/ALL/1/yes';?>"> <span> Change Membership Plan </span> </a>
                            </li>
                            <?php
							}
							?>
							...
							if($user_type != 'franchise')
							{
								...
								<li class="follow_up_report follow_up_report_add" id="follow_up_report">
									<a href="<?php echo $base_url.$admin_path.'/member/follow-up-report/Next/1/yes';?>"> <span>Member Follow-up Report</span> </a>
								</li>
							...
							if($user_type == 'admin' || $user_type == 'franchise')
							{
								...
								<li class="sales_report all_list view_invoice" id="all_list">
									<a href="<?php echo $base_url.$admin_path.'/member/all-list/ALL/1/yes';?>"> <span>Member Sales Report</span> </a> 
								</li>
								<?php
								}
							?>
...
/*
						...
						if($user_type == 'admin')
						{
							...
							<li id="user_activity"> 
								...
								<ul class=sub-menu>
									...
									<li class="user_activity_add" id="chat">
									<!-- For issue end 29/11/2021  -->
									<a href="<?php echo $base_url.$admin_path.'/user-activity/chat/ALL/1/yes';?>"> <span>Chat</span> </a> 
									</li>
									<!-- <li class="user_activity_add" id="message"> -->
									 <!-- For issue start 29/11/2021  -->
									...
									<li class="user_activity_add" id="user_login_history">
										<a href="<?php echo $base_url.$admin_path.'/user-activity/user_login_history/ALL/1/yes';?>"> <span>Login History</span> </a> 
									</li>
									<li class="user_analysis_list" id="index">
										<a href="<?php echo $base_url.$admin_path.'/user-activity/user-analysis-list/ALL/1/yes';?>"> <span>Users Analytics</span> </a>
									</li>
								</ul>
							</li>	
							<li id="member_plan">
								...
								<ul class="sub-menu">
									...
									<li class="member_plan plan_category" id="plan_category">
										<a href="<?php echo $base_url.$admin_path.'/member-plan/plan-category/ALL/1/yes';?>"> <span>Plan Category</span></a> 
									</li>							
								</ul>
							</li>	
							<li id="manage_coupan">
					...
					<?php
							...
							<li id="lead_generation">
								...
								<ul class="sub-menu">
									...
									<li class="lead_generation_follow_up_report lead_generation_follow_up_report_add" id="lead_generation_follow_up_report">
										<a href="<?php echo $base_url.$admin_path.'/lead-generation/lead-generation-follow-up-report/Next/1/yes';?>"> <span>Lead Generation Report</span> </a>
									</li>
								</ul>
							</li>
							<?php 
						...
						if($user_type == 'admin')
						{
							...
							<li id="staff">
								...
								<ul class="sub-menu">									
									...
									<li class="staff staff_add" id="staff_list">
										<a href="<?php echo $base_url.$admin_path.'/staff/staff-list/ALL/1/yes';?>"> <span>Staff List</span> </a>
									</li>
									<li id="staff_assign_history">
										<a href="<?php echo $base_url.$admin_path.'/staff/staff-assign-history/ALL/1/yes';?>"> <span>Staff Assigned Members</span> </a>
									</li>
									<li id="staff_unassign_history">
										<a href="<?php echo $base_url.$admin_path.'/staff/staff-unassign-history/ALL/1/yes';?>"> <span>Staff Unassigned Members</span> </a>
									</li>
									<li id="staff_lead_assign_history">
										<a href="<?php echo $base_url.$admin_path.'/staff/staff-lead-assign-history/ALL/1/yes';?>"> <span>Staff Assigned Lead</span> </a>
									</li>
									<li id="staff_lead_unassign_history">
										<a href="<?php echo $base_url.$admin_path.'/staff/staff-lead-unassign-history/ALL/1/yes';?>"> <span> Staff Unassigned Lead</span> </a>
									</li>
								</ul>
							</li>
							<li id="franchise">
								...
								<ul class="sub-menu">
									<li class="franchise franchise_add" id="franchise_list">
										<a href="<?php echo $base_url.$admin_path.'/franchise/franchise-list/ALL/1/yes';?>"> <span>Franchise List</span> </a>
									</li>
									<li class="" id="franchise_member">
										<a href="<?php echo $base_url.$admin_path.'/franchise/franchise-member/ALL/1/yes';?>"> <span>Franchise Members</span> </a>
									</li>
									<li id="franchise_assign_history">
										<a href="<?php echo $base_url.$admin_path.'/franchise/franchise-assign-history/ALL/1/yes';?>"> <span>Franchise Assigned Members</span> </a>
									</li>
									<li id="franchise_unassign_history">
										<a href="<?php echo $base_url.$admin_path.'/franchise/franchise-unassign-history/ALL/1/yes';?>"> <span>Franchise Unassigned Members</span> </a>
									</li>
									<li id="franchise_lead_assign_history">
										<a href="<?php echo $base_url.$admin_path.'/franchise/franchise-lead-assign-history/ALL/1/yes';?>"> <span>Franchise Assigned Lead</span> </a>
									</li>
									<li id="franchise_lead_unassign_history">
										<a href="<?php echo $base_url.$admin_path.'/franchise/franchise-lead-unassign-history/ALL/1/yes';?>"> <span>Franchise Unassigned Lead</span> </a>
									</li>
									<li class="franchise_sales_report" id="">
										<a href="<?php echo $base_url.$admin_path.'/franchise/franchise-sales-report/ALL/1/yes';?>"> <span>Franchise Sales Report</span> </a>
									</li>
								</ul>
							</li>
							<li id="payment_option"> 
								<a href=javascript:;> <i class="fa fa-bar-chart"></i> <span>Payment Gateway</span> </a>
								<ul class=sub-menu>
									<li class="payment_option_add" id="payment_list">
										<a href="<?php echo $base_url.$admin_path.'/payment-option/payment-list/ALL/1/yes';?>"> <span>All Payment Gateway</span> </a> 
									</li>
									<li class="payment_option_add" id="offline_bank_payment">
										<a href="<?php echo $base_url.$admin_path.'/payment-option/offline-bank-payment/ALL/1/yes';?>"> <span>Offline Payment</span> </a> 
									</li>
									<li class="payment_option_add" id="scan_pay">
										<a href="<?php echo $base_url.$admin_path.'/payment-option/scan-pay/ALL/1/yes';?>"> <span>Scan & Pay</span> </a> 
									</li>
								</ul>
							</li>
							<li id="email_templates">
								<a href=javascript:;> <i class="fa fa-envelope"></i> <span>Email Configuration</span> </a>
								<ul class=sub-menu>
									<li id="email_templates">
							...
							<li id="sms_templates">
								<a href=javascript:;> <i class="fa fa-mobile"></i> <span>SMS Configuration</span> </a>
								<ul class=sub-menu>
					...
					if($filter_profile_perm !='No')
					{
						...
						<li id="bulk_email_sms">
							<a href=javascript:;> <i class="fa fa-envelope-o"></i> <span>Send Bulk Email</span> </a>
							<ul class=sub-menu>
					...
					if($user_type == 'admin')
					{
						...
						<li id="content_management"> 
							...
							<ul class=sub-menu>
								<li class="new_listing_add" id="faq_list">
									<a href="<?php echo $base_url.$admin_path.'/content-management/faq-list/ALL/1/yes';?>"> <span>Add FAQs</span> </a> 
								</li>
						...
						<li id="wedding_vendors"> 
							<a href=javascript:;> <i class="fa fa-book"></i> <span>Wedding Planner</span> </a>
							<ul class=sub-menu>
								...
								<li class="wedding_vendors_add">
									<a href="<?php echo $base_url.$admin_path.'/wedding-vendors/vendors-list/add-data';?>"> <span>Add New Vendors</span> </a>
								</li>
								...
								<li class="approval" id="wedding_vendors_review">
									<a href="<?php echo $base_url.$admin_path.'/wedding-vendors/wedding-vendors-review/ALL/1/yes';?>"> 
						...
						<li id="ticket_management"> 
							<a href=javascript:;> <i class="fa fa-bar-chart"></i> <span>Admin Support</span> </a>
							<ul class=sub-menu>
								<li class="ticket_management_add" id="ticket_list">
									<a href="<?php echo $base_url.$admin_path.'/ticket-management/ticket-list/ALL/1/yes';?>"> <span>Support Ticket</span> </a> 
								</li>
							</ul>
						</li>
